...
function drawNametagLegacy(): ImageData {
   const nameTagStatus = nametags.getNametagStatus();
   const currentNameTag = nametags.getCurrentNametag();
   const selectedWaveHand = hands.getCurrentHand();
   const waveHands = hands.getHandChoicesAsString();
   return drawNametag(nameTagStatus, currentNameTag, selectedWaveHand, waveHands);
}
